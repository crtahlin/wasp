...
| [#438](https://github.com/crtahlin/wasp/issues/438) | retrieval: a flight ends on the error budget while a request is still in flight, so the delivery is thrown away | open | `spec/438-flight-exit`, `fix/438-flight-exit` | - |
