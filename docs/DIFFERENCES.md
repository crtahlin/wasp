...
- **Compared with:** Bee **v2.8.2**, the latest released version of upstream Bee
  on 2026-09-10.
- **wasp described:** commit `b1ddd133`, 2026-09-20. The latest wasp release is
  v0.1.3.
