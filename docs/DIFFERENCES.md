...
- **Compared with:** Bee **v2.8.2**, the latest released version of upstream Bee
  on 2026-09-10.
- **wasp described:** the tip of `fix/333-threshold-growth-reconnect`, 2026-09-21,
  the last commit that changes what a node does. Replaced with the merge commit
  once this branch lands. The latest wasp release is v0.1.3.
